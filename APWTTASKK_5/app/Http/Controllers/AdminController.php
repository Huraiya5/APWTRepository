    ...
    public function riderAdd(Request $request){
      ...
      ->first();
        ...
        public function APIPost(Request $request){
            $rides = new  Rides();
            $rides->id = $request->id;
            $rides->customerName = $request->customerName;
            $rides->customerId = $request->customerId;
            $rides->customerPhone = $request->customerPhone;
            $rides->pickupPoint = $request->pickupPoint;
            $rides->destination = $request->destination;
            $rides->length = $request->lenght;
            $rides->cost = $request->cost;
            $rides->riderId = $request->riderId;
            $rides->riderName = $request->riderName;
            $rides->riderPhone = $request->riderPhone;
            $rides->customerStatus = $request->customerStatus;
            $rides->riderStatus = $request->riderStatus;
            $rides->save();
        }
